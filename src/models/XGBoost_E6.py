...
predictors = ['ESTU_GRADO',  'COLE_COD_ICFES', 'COLE_COD_MCPIO', 'COLE_COD_DPTO',
...
experiments = [
    ...
    },
    {
        ...
        "params": {
            "description": "Escenario 6.4 - Todas las variables categóricas y numéricas, categorización de los resultados según respuestas: 0 (0-6 correctas), 1 (7-13 correctas), y 2 (14-20 correctas).",
            "predictors": predictors,
